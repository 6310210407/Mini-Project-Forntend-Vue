          ...
          <v-container>
            <v-row>
              <v-col cols="12" sm="6" md="6">
                <v-text-field v-model="productName" label="productName"></v-text-field>
              </v-col>
              <v-col cols="12" sm="6" md="6">
                <v-text-field v-model="productPrice" label="productPrice"></v-text-field>
              </v-col>
              <v-col cols="12" sm="6" md="6">
                <v-text-field v-model="productAmount" label="productAmount"></v-text-field>
              </v-col>
              <v-col cols="12" sm="6" md="6">
                <v-text-field v-model="productDetail" label="productDetail"></v-text-field>
              </v-col>
            </v-row>
          </v-container>
        </v-card-text>
  ...
  methods: {
    ...
    async save (action) {
      ...
      if (action === 'เพิ่มข้อมูล') {
        ...
        try {
          var dataResponse1 = await this.axios.put('http://172.28.48.249:9000/product/' + this.idProduct, data)
